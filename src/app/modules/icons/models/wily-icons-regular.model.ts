...
// wir fa-person-name
  static wirPersonName = {
    ...
    icon: [
      24, 24,
      [],
      null, 'M21,18a4.1078,4.1078,0,0,0-4.2-4H16v-.5563A3.9869,3.9869,0,0,0,18,10V1H10A4.0042,4.0042,0,0,0,6,5v5a3.9869,3.9869,0,0,0,2,3.4437V14H7.2A4.1078,4.1078,0,0,0,3,18v3H2v2H22V21H21Zm-7-6H10a2.0023,2.0023,0,0,1-2-2V6.8682L9.7363,6h4.5274L16,6.8682V10A2.0023,2.0023,0,0,1,14,12ZM10,3h6V4.6318L14.7363,4H9.2637l-1.2245.6122A2.0024,2.0024,0,0,1,10,3Zm4,11v.799l-.0137.0125a2.93,2.93,0,0,1-3.9316-.0215L10,14.7383V14Zm3,7V18H16v3H8V18H7v3H5V18a2.11,2.11,0,0,1,2.2-2H8.4238l.2578.2441a4.9614,4.9614,0,0,0,6.6592.0391L15.6484,16H16.8A2.11,2.11,0,0,1,19,18v3Z'
    ]
  };
