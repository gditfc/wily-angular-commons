...
export * from './app/modules/wily-dialog-legacy/wily-dialog-legacy.module';
...
export * from './app/modules/wily-dialog-legacy/wily-dialog-legacy.component';
export * from './app/modules/endpoint-state/components/endpoint-state.component';
export * from './app/modules/wily-dialog/wily-dialog.component';
